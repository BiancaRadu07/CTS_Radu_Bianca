...
public class AsigurareMedicala {
	...
	private static AsigurareMedicala asigurareMedicala = new AsigurareMedicala(1, "Radu Bianca", 250.5f);
	
	//deoarece avem constructorul privat nu-l mai putem apela de oriunde
